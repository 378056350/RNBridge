...
#define kIS_IPHONEXR         (kScreenWidth == 414.f && kScreenHeight == 896.f ? YES : NO)
#define kIS_IPHONEX          (kScreenWidth == 375.f && kScreenHeight == 812.f ? YES : NO)
#define kIS_IPHONE11         (kScreenWidth == 828.f && kScreenHeight == 1792.f ? YES : NO)
#define kIS_IPHONE11Pro      (kScreenWidth == 1125.f && kScreenHeight == 2436.f ? YES : NO)
#define kIS_IPHONE11ProMax   (kScreenWidth == 1242.f && kScreenHeight == 2688.f ? YES : NO)
...
- (void)updateFrame {
    ...
    self.titleImage.frame = CGRectMake((kWRScreenWidth - titleLabelWidth) / 2, top, titleLabelWidth, titleLabelHeight);
}
...
- (void)wr_setBottomLineColor:(UIColor *)color {
...
- (void)setTitleView:(UIView *)titleView {
    ...
    [_titleView setCenterX:kScreenWidth / 2];
    [_titleView setTop:kStatusBarHeight];
